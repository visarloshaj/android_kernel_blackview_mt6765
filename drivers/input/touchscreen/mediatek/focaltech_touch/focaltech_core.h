...
struct fts_ts_data {
    ...
    bool swipe_right_enable;
    bool swipe_left_enable;
    bool swipe_up_enable;
    bool swipe_down_enable;
    bool letter_o_enable;
    bool letter_e_enable;
    bool letter_m_enable;
    bool letter_w_enable;
    bool letter_l_enable;
    bool letter_s_enable;
    bool letter_v_enable;
    bool letter_c_enable;
    bool letter_z_enable;
    /* multi-touch */
